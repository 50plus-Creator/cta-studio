...
const TemplateRenderer = ({ project, template }: Props) => {
  ...
  return (
    <div id="cta-export-canvas" className="template-renderer" style={{ '--canvas-heading-font': toFontFamily(heading), '--canvas-body-font': toFontFamily(body) } as CSSProperties}>
