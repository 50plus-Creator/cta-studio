...
const TemplateRenderer = ({ project, template }: Props) => {
  ...
  return (
    <div id="cta-export-canvas" className="template-renderer notranslate" translate="no" data-project-id={project.template.id === 'brivion-education-vertical-v1' ? 'brivion-campaign-v1' : project.id} style={{ '--canvas-heading-font': toFontFamily(heading), '--canvas-body-font': toFontFamily(body) } as CSSProperties}>
