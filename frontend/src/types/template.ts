...
export type MediaAsset = { id?: string; type: MediaType; src: string; alt?: string; autoplay?: boolean; loop?: boolean; muted?: boolean; ctaDisplay?: 'always' | 'last-seconds' | 'hidden'; ctaLastSeconds?: number }
